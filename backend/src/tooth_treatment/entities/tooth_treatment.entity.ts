...
export class ToothTreatment {
  ...
  @ManyToOne(() => Appointment, (appointment) => appointment.toothTreatments, {
    nullable: false,
    onDelete: 'CASCADE',
  })
  ...
  @ManyToOne(() => Treatment, (treatment) => treatment.toothTreatments, {
    nullable: false,
    onDelete: 'CASCADE',
  })
  ...
  @ManyToOne(() => Dentist, { nullable: false, onDelete: 'RESTRICT' })
