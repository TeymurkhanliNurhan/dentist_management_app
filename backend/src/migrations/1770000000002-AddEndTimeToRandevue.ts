...
export class AddEndTimeToRandevue1770000000002 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`UPDATE "Randevue" SET "endTime" = "date" WHERE "endTime" IS NULL`);
        await queryRunner.query(`ALTER TABLE "Randevue" ALTER COLUMN "endTime" SET NOT NULL`);
    }
